...
namespace ConsoleApp
{
    internal class Experiment
    {
        ...
        public void run()
        {
            ...
            int[] encodedInputImage = ReadImageData("C:/SE/neocortexapi-classification/ImageClassification/ImageClassification/bin/Debug/net6.0/InputFolder/Cabbage/S0_1.jpg", width, height);
